...
export default class PersonalAccountDoctorSettings extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  async handleSubmit(e) {
    ...
    console.log(data);
    try {
      let response = await axiosInstance.put("auth/users/doctor/", data);
              ...
              <Container className="justify-content-left child-left">
                <Col className="mb-5 justify-content-left child-left">
                  ...
                  <Row className="p-3">
                    ...
                    >
                      <p className="text-center my-auto text-lighter">
                        Back to Profile
                      </p>
                    </AddButton>
                  </Row>
                    ...
                    >
                      ...
                      <InputGroup className="mb-3 ">
                        ...
                        <Form.Control
                          ...
                          name="specification"
                          onChange={(e) => this.onChange(e)}
                          defaultValue={this.state.profile.specification.id}
                        >
