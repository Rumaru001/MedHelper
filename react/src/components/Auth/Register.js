...
class Register extends Component {
  ...
  handleChange(event) {
    ...
    switch (name) {
      ...
      case "password2":
        ...
        errors.password2 =
          value !== this.state.values.password ? "Passwords do not equal!" : "";
        break;
      case "user-type":
  ...
  async handleSubmit(event) {
    event.preventDefault();
    let flag =
      validateForm(this.state.values) && countErrors(this.state.errors);
      ...
      <div className="wrapper-auth">
        <div className="form-wrapper-auth">
          ...
          <form className="form-auth" onSubmit={this.handleSubmit} noValidate>
            ...
            <div className="password-auth">
              <label className="label-auth" htmlFor="user-type">
                User type
              </label>
              <select
                name="user-type"
